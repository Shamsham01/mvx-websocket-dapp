...
/** Single muted emerald accent — avoids cyan + purple “AI gradient” clichés. */
const accent = '#5cbb9f';
    ...
    MuiCard: {
      ...
      styleOverrides: {
        root: {
          ...
          backgroundImage: `linear-gradient(165deg, ${alpha(surfaceRaised, 0.95)} 0%, ${alpha(surface, 0.88)} 100%)`,
          boxShadow: `
